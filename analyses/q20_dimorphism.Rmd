...
```{r q20_dimorphisme_1, echo = FALSE, fig.width = 9, fig.height = 5}
...
```{r q20_dimorphisme_2, echo = FALSE, fig.width = 9, fig.height = 5}
...
```{r q20_dimorphisme_3, echo = FALSE, fig.width = 9, fig.height = 5}
df <- bio_gen %>%
